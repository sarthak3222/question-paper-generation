            ...
            if (ImgSrc.HasFile)
            {
                ...
                if (chk.Contains(str))
                {
                    try
                    {
                        ...
                        x.conopen();
                        qry = "insert into faculty_mster values ('" + txtsname.Text + "','" + txtaddress.Text + "','" + txtmob_no.Text + "','" + txtemail.Text + "','" + Gender + "','" + date1.ToString() + "','" + DropDownList1.SelectedValue + "','" + pass.ToString() + "','" + fname + "')";
                        x.iud(qry);
                        x.conclose();
                        clear();
                    }
